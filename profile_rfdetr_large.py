#!/usr/bin/env python3
"""
Profile rfdetr-large inference using NVIDIA Nsight Systems.
...
Usage:
    nsys profile -o rfdetr_large_profile python profile_rfdetr_large.py
"""
...
def main():
    ...
    print("RF-DETR large Profiling", file=sys.stderr)
    print("=" * 80, file=sys.stderr)
    ...
    torch.cuda.nvtx.range_push("rfdetr_large_inference_batch")
